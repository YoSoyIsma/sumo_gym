...
class FourIntersectsEnv(Env):
    ...
    def __init__(self, traffic_light_junction_lanes_dict, version_num):
        self.seed()
        # sumo_binary = "C/Users/Ismael/Desktop/New folder/Reinforcement_learning_project_traffic-signal-control-master/four_intersects_env.py"
        sumo_binary = checkBinary('sumo')
        # sumo_config_file = 'sumo_env/four_intersects_' + str(version_num) + '.sumocfg'
        sumo_config_file = '"C/Users/Ismael/Desktop/New folder/Reinforcement_learning_project_traffic-signal-control-master/sumo_env/four_intersects_' + str(version_num) + '.sumocfg'
